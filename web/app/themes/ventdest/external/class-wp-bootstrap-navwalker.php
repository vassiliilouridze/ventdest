...
if ( ! class_exists( 'WP_Bootstrap_Navwalker' ) ) {
  ...
  class WP_Bootstrap_Navwalker extends Walker_Nav_Menu {
    ...
    public function start_el( &$output, $item, $depth = 0, $args = array(), $id = 0 ) {
      ...
      if ( (0 == $item->menu_item_parent && isset( $args->has_children ) && $args->has_children) || !empty( get_field('menu_item_subtitle', $item) )) {
        $classes[] = 'full-nav-item';
      }elseif(0 == $item->menu_item_parent){
        $classes[] = 'simple-nav-item';
      }
      ...
      if ( isset( $args->has_children ) && $args->has_children && 0 === $depth && $args->depth > 1 ) {
        ...
        }elseif( ($depth == 0 && $args->has_children) || !empty( get_field('menu_item_subtitle', $item)) ){
          $atts['class'] = 'main-nav-link nav-link'; 
        }elseif( $depth == 0){
          $atts['class'] = 'secondary-nav-link nav-link'; 
        }else {
          $atts['class'] = 'nav-link';
        }
      }
      ...
      $subtitle = get_field('menu_item_subtitle', $item);
      if(isset($subtitle) && !empty($subtitle)){
        $item_output .= '<span class="nav-link-title">' . $icon_html . $title . '<span class="nav-link-subtitle">'. $subtitle . '</span>' . '</span>';
      }else{
