      ...
      <?php while(have_rows($fc)): the_row(); ?>
        ...
        <div class="col-md-4">
          <?php if($media_select == 'image'): ?>
            <?php echo wp_get_image_attachment(get_sub_field('image'), 'lrg_size'); ?>
  ...
  <div class="<?php echo $left_size; ?>">
    <?php while(have_rows($fc)): the_row(); ?>
      <?php
        ...
        set_query_var('subindex', '1');
       ?>
      <div class="card <?php echo $color; if($layout == 'horizontal'){ echo ' flex-md-row box-shadow align-horizontal'; } ?>">
        <?php get_template_part( 'parts/acf/card' ); ?>
      </div>
    <?php endwhile; ?>
  </div>
